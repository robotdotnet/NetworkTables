...
Task("Pack")
    ...
    .Does(() =>
    {
        ...
        {
            "./src/FRC.NetworkTables.Core/*.csproj",
            "./src/FRC.NetworkTables.Core.DesktopLibraries/*.csproj",
            "./src/FRC.NetworkTables.Core.Web/*.csproj"
        };

        foreach (var project in matchers.Select(x => GetFiles(x).First()))
        {
